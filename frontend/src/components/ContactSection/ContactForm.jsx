...
//         {/* Left */}
//         <div>
//           <span className="text-sm font-medium text-[#ee6c4d] px-1 uppercase">Contact</span>
...
//             <ContactInfoItem icon={Mail} title="Email to us" value="cycle@company.com" />
//             <ContactInfoItem icon={Phone} title="Phone number" value="(480) 555-0103" />
//             <ContactInfoItem icon={MapPin} title="Address" value="2715 Ash Dr. San Jose" />
//           </div>
//         </div>
