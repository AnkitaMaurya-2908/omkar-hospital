...
//       <div className="absolute -top-19 -left-15 w-75 sm:w-83 md:w-92 h-70 pointer-events-none">
//         <Image
...
//             <span
//               key={item}
//               className="bg-zinc-200 text-[#293241] text-xs font-light px-4 py-1 rounded-full cursor-pointer transition-colors duration-200 hover:bg-[#3d5a80] hover:text-white"
//             >
//               {item}
//             </span>
//           ))}
...
//         <button className="absolute bottom-2 right-6 text-sm font-medium text-[#ee6c4d] hover:text-[#3d5a80] flex items-center gap-1">
//           See Details →
//         </button>
//       </div>
//     </div>
...
const DoctorCard = () => {
  return (
    <div className="group relative bg-zinc-50 shadow-sm rounded-2xl p-3 md:p-6 pl-40 sm:pl-48 md:pl-56 overflow-visible h-53 sm:h-60 md:h-70 lg:h-70 
      ...
      <div className="pl-6 whitespace-nowrap md:whitespace-normal">
        ...
        {/* Button */}
        <button className="absolute bottom-2 right-6 text-sm font-medium text-[#ee6c4d] hover:text-[#3d5a80] 
